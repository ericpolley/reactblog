...
export default function Blog007() {
  return (
    ...
    <article>
      ...
      <p> 
        Hello everyone, <br />
        I am writing this before I record the vlog video listed in the links below. <br />
        ...
        <br />
         This is also a great landing page and index for all of my projects. This helps me keep organized and gives a clear date for career related milestones. I plan to continue this blog for years to come. Though I am sure it will evolve along the way. <br />
        <br />
        ...
        <br />
        <br />
        Alright then, I am signing off, till next time <br /><br /> -Eric
    ...
    <ul>
      ...
      <li>
        <a
          href="https://ericpolley.github.io/Math-Quiz/"
          title="Math Quiz Game"
        >
          <strong><p>Math Quiz Game</p></strong></a
        >
      </li>
      <li>
        <a
